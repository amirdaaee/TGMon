...
- `NEXT_PUBLIC_MINIO_URL` — public MinIO prefix used for thumbnails and sprite VTT (same form as `STASH_REDIRECTOR__MINIO_URL`, e.g. `http://localhost:9000/bucket`). Leave empty to skip thumbs/sprites.
