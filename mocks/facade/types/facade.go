...
// Source: internal/facade/types/facade.go
//
// Generated by this command:
//
//	mockgen -source=internal/facade/types/facade.go -destination=mocks/facade/types/facade.go -package=mocks_facade_types
//
