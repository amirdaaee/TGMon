...
//
//	mockgen -source=collection.go -destination=../../../mocks/db/mongo/collection.go -package=mocks_db_mongo
//

// Package mocks_db_mongo is a generated GoMock package.
package mocks_db_mongo
