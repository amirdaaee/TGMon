...
func (_m *MockIMongo) GetCollection(cl db.IMongoClient) db.IMongoCollection {
	ret := _m.Called(cl)
...
func (_c *MockIMongo_GetCollection_Call) Return(_a0 db.IMongoCollection) *MockIMongo_GetCollection_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIMongo_GetCollection_Call) RunAndReturn(run func(db.IMongoClient) db.IMongoCollection) *MockIMongo_GetCollection_Call {
	_c.Call.Return(run)
	return _c
}
